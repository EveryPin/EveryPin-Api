...
namespace EveryPinApi.Migrations
{
    ...
    [Migration("20250524081719_Profile 업로드 개선 (Origin 파일명, uploaded 파일명 추가)")]
    partial class Profile업로드개선Origin파일명uploaded파일명추가
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entites.Models.Profile", b =>
                {
                    ...
                    b.Property<string>("OriginPhotoFileName")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("PhotoUrl")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ProfileDisplayId")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "b706669d-62e2-4d7b-8fab-1b8ead2fcadd",
                            Name = "NormalUser",
                            NormalizedName = "NORMALUSER"
                        },
                        new
                        {
                            Id = "184cea9e-779c-470b-8494-5f8a515898e2",
                            Name = "Administrator",
